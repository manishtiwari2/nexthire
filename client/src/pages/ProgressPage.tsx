...
import { SectionHeader, StatCard, Card, Spinner, Badge, Button } from '../shared/components/ui';
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        {isLoading || !stats ? (
          <div className="flex justify-center py-16"><Spinner label="Loading your stats…" /></div>
        ) : (
          <>
