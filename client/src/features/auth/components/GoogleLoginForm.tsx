    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <button
          ...
          className="w-full py-3.5 px-4 bg-white border border-slate-300 hover:border-slate-400 hover:bg-slate-50 active:scale-[0.98] text-slate-800 font-bold rounded-2xl shadow-sm hover:shadow-md flex items-center justify-center gap-3 transition-all duration-150 text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        >
          {isGoogleLoading ? (
